...
describe("cache.ts", () => {
  describe("Cache", () => {
    test.each([
      ...
      ({ numeroLineas, tamanoLineas, asociatividad, numeroLineasVC }) => {
    ...
    test.each([
      ...
      "Calcula correctamente las propiedades bitMaxLinea y bitMaxConjunto",
      ({ numeroLineas, asociatividad, bitMaxLinea, bitMaxConjunto }) => {
    ...
    test.each([
      ...
      {
        direccion: 0x12345678,
        numeroLineas: 512,
        asociatividad: 4,
        conjuntoEsperado: 89,
      }, // 0x12345678 = 0001001000110100010|1011001|111000
      {
        direccion: 0x87654321,
        numeroLineas: 512,
        asociatividad: 4,
        conjuntoEsperado: 12,
      }, // 0x87654321 = 1000011101100101010|0001100|100001
      {
        direccion: 0xffffffff,
        numeroLineas: 512,
        asociatividad: 4,
        conjuntoEsperado: 127,
      }, // 0xFFFFFFFF = 1111111111111111111|1111111|111111
      {
        direccion: 0x00000000,
        numeroLineas: 512,
        asociatividad: 4,
        conjuntoEsperado: 0,
      }, // 0x00000000 = 0000000000000000000|0000000|0000000
      ...
      // Configuración 2: numeroLineas = 256, asociatividad = 8
      {
        ...
        asociatividad: 8,
        conjuntoEsperado: 25,
      }, // 0x12345678 = 000100100011010001010|11001|111000
      {
        direccion: 0x87654321,
        numeroLineas: 256,
        asociatividad: 8,
        conjuntoEsperado: 12,
      }, // 0x87654321 = 100001110110010101000|01100|100001
      {
        direccion: 0xffffffff,
        numeroLineas: 256,
        asociatividad: 8,
        conjuntoEsperado: 31,
      }, // 0xFFFFFFFF = 111111111111111111111|11111|111111
      {
        direccion: 0x00000000,
        numeroLineas: 256,
        asociatividad: 8,
        conjuntoEsperado: 0,
      }, // 0x00000000 = 000000000000000000000|00000|0000000
      ...
      // Configuración 3: numeroLineas = 2048, asociatividad = 32
      {
        ...
        asociatividad: 32,
        conjuntoEsperado: 25,
      }, // 0x12345678 = 00010010001101000101|011001|111000
      {
        direccion: 0x87654321,
        numeroLineas: 2048,
        asociatividad: 32,
        conjuntoEsperado: 12,
      }, // 0x87654321 = 10000111011001010100|001100|100001
      {
        direccion: 0xffffffff,
        numeroLineas: 2048,
        asociatividad: 32,
        conjuntoEsperado: 63,
      }, // 0xFFFFFFFF = 11111111111111111111|111111|111111
      {
        direccion: 0x00000000,
        numeroLineas: 2048,
        asociatividad: 32,
        conjuntoEsperado: 0,
      }, // 0x00000000 = 00000000000000000000|000000|0000000
    ...
    test.each([{ numeroHits: 1 }, { numeroHits: 2 }])(
      "Contabiliza los hit correctamente",
      ({ numeroHits }) => {
    ...
    test.each([{ numeroMisses: 1 }, { numeroMisses: 2 }])(
      "Contabiliza los miss correctamente",
      ({ numeroMisses }) => {
        const numeroLineas = 1024;
        const tamanoLineas = 64;
